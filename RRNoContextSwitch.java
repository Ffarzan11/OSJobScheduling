...
public class RRNoContextSwitch {
     ...
     */
    public RRNoContextSwitch(JobObject[] jobs) {
    ...
    public void print() {
        System.out.println("Round Robin Scheduling without context switch");
